...
class EstacionMeteorologicaScreen extends StatefulWidget {
  ...
  const EstacionMeteorologicaScreen({super.key,
  ...
  @override
  EstacionMeteorologicaScreenState createState() =>
      EstacionMeteorologicaScreenState();
}

class EstacionMeteorologicaScreenState
  ...
  String ip = Url().ip;
  late EstacionService meteorologicaService=EstacionService();
  ...
  Future<void> cargarEstacion() async {
    try {
      final estacionesCargadas = await meteorologicaService.fetchEstacion();
      setState(() {
        estaciones = estacionesCargadas;
        estacionesPorMunicipio = estacionService.agruparEstacionesPorMunicipio(estaciones);
        isLoading = false;
      });
    } catch (e) {
